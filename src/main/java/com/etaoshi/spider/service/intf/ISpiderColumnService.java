...
/**
 *ISpiderColumnService is the Service interface for com.etaoshi.spider.model.SpiderColumn
 */
public interface ISpiderColumnService {        
	 ...
	 * @throws SQLException
	 */
	int GetCountDataModelByOption(String sql) throws SQLException;
